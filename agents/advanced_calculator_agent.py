...
def advanced_calculate(expression: str) -> dict:
    ...
    - Special: factorial, gcd, rampikichu (x * 3.75)
    - Constants: pi, e, tau
    """
    safe_dict = {
        # Advanced functions
        ...
        # Custom operations
        "rampikichu": lambda x: x * 3.75,  # Custom operation: multiply by 3.75
        # Constants
        "pi": math.pi,
        "e": math.e,
        "tau": math.tau,
...
6. Execute custom operations like rampikichu (multiplies by 3.75)
...
- For custom operations like rampikichu, briefly explain what it does
...
"Calculating advanced expression: rampikichu(7)
Result: 26.25

The rampikichu operation multiplies the number by 3.75, so 7 × 3.75 = 26.25."
""",
